		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MR Monitoring",
									"targetURL": "#zuimrmonitoring-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuimrmonitoring-display": {
								"semanticObject": "zuimrmonitoring",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuimrmonitoring",
									"url": sap.ui.require.toUrl("zuimrmonitoring")
								}
							}
						}
					}
